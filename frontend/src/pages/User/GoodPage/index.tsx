...
import CreateReviewModal from '../../../components/Modals/CreateReview';
          ...
          },
          {
            ...
            children: (
              <div className={styles.reviews}>
                <CreateReviewModal good_id={response.data.id_good} name={response.data.good_name} />
                <ReviewsList good_id={response.data.id_good} />
              </div>
            ),
          },
        ]);
